...
public class ClassLevelProgressionExtractorTests
{
    ...
    private static readonly string[] Headers =
        { "Class", "Level", "ProficiencyBonus", "Feature", "ClassTraits", "Modifiers", "NameES", "DescriptionES" };

    [Fact]
    public void Extract_CreatesProgressionWithFeatureAndTraits()
    {
        var wb = CreateWorkbook("ClassLevelProgression", Headers,
            new[] { "Wizard", "1", "2", "Spellcasting", "SpellSlots:[4,3,2,1,0,0,0,0,0]|PreparedSpellsCount:3", "[]", "Lanzamiento", "Desc" });
    ...
    {
        var wb = CreateWorkbook("ClassLevelProgression", Headers,
            new[] { "Wizard", "1", "2", "Spellcasting", "", "[]", "Lanzamiento", "Desc" },
            new[] { "Wizard", "1", "2", "ArcaneRecovery", "PreparedSpellsCount:3", "[]", "Recuperación", "Desc" });
        var ctx = CreateContext();
